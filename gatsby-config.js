...
module.exports = {
  siteMetadata: {
    ...
    description: 'Every generation needs to proof that deserve freedom',
    siteUrl: 'https://www.historia.waszczyk.com', // full path to blog - no ending slash
  },
  mapping: {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        ...
        trackingIds: [
          "G-NCPWL47DK6", // Google Analytics / GA
        ],
